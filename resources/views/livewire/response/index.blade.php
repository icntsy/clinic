...
@section('page_title', 'MASTER DATA RESPONSE')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <a href="{{ route('response.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                            Tambah Data</a>
                        </div>
                        <div class="col-md-6 col-sm-12">
                        ...
                        <div class="col-md-12">
                            <table class="mb-0 table table-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <livewire:response.single :response="$response" :key="time()" />
                                    @empty
